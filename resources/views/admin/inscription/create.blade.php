            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Ajouter une Inscription</li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <div class="card border-top border-0 border-4 border-primary">
                    <div class="card-body p-5">
                        <div class="card-title d-flex align-items-center">
                            ...
                            <h5 class="mb-0 text-primary">Ajouter une Inscription</h5>
                        </div>
                        <hr>
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <select class="form-select" name="epreuve_id" required>
                                        @foreach($epreuves as $epr)
                                            <option value="{{ $epr->id }}" {{ $epr->id == $epreuve->id ? 'selected' : '' }}>
                                                {{ $epr->nom }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <button type="submit" class="btn btn-primary px-4">
                                        <i class="bx bx-save"></i> Enregistrer l'Inscription
                                    </button>
